...
상태는 상위 컴포넌트에서만 소유하고,
하위 컴포넌트는 props로 전달받은 값과 콜백만 사용하도록 설계했습니다.
...
- 상태 변경 지점을 한 곳에서 추적할 수 있고
- 컴포넌트 간 양방향 의존이나 순환 참조를 방지할 수 있으며
- React의 선언적 UI + 단방향 데이터 흐름 모델과 자연스럽게 맞물리는 구조를 유지할 수 있습니다.
